...
export default async function handler(req, res) {
  ...
  try {
    ...
    const keyId = process.env.B2_APOSTILA_KEY_ID;
    const secret = process.env.B2_APOSTILA_APPLICATION_KEY;
    ...
    console.error(error);
    return res.status(500).json({ error: "Erro ao gerar acesso à apostila" });
  }
}
